...
<body>
    <table border="1" bordercolor="red">
        ...
        <tr>
            <td>
                <form name="fm-input" method="GET" action="proses_biodata.php">
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input type="text" size="20" name="tempat" id="tempat" />,
                                <input type="text" size="2" name="tgl" id="tgl" />/
                                <input type="text" size="2" name="bln" id="bln" />/
                                <input type="text" size="4" name="thn" id="thn" />
                            </td>
                        </tr>
                        <tr>
